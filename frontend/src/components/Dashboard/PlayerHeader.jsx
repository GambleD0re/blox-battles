// frontend/src/components/Dashboard/PlayerHeader.jsx
    ...
    return (
        <header className="dashboard-header !p-4">
            <div className="player-info !gap-4">
                ...
                <img src={user.avatar_url || `https://ui-avatars.com/api/?name=${user.username.charAt(0)}&background=2d3748&color=e2e8f0`} alt="Avatar" className="player-avatar !w-16 !h-16" />
                <div>
                    <h1 className="player-name !text-2xl">{user.username}</h1>
