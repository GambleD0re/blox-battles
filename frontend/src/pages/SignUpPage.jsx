...
const SignUpPage = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-900 py-12">
            <div className="w-full max-w-md p-8 space-y-4 bg-[var(--widget-bg)] rounded-xl shadow-lg border border-[var(--widget-border)] text-center relative">
                ...
                <p className="text-gray-400 !mb-6">Join the arena and start dueling.</p>
                ...
                <a href={GOOGLE_AUTH_URL} onClick={handleGoogleClick} className={`w-full flex items-center justify-center gap-3 bg-gray-700 hover:bg-gray-600 border border-gray-600 text-gray-200 font-semibold py-3 px-4 rounded-lg transition ${!isRegistrationEnabled ? 'pointer-events-none opacity-50' : ''}`}>
